    ...
    <div class="container-cart" v-if="cart.length > 0 || step == Enum.Step.Done">
        ...
        <div class="order-cart">
            ...
            <div class="box-cart payment" v-else-if="step == Enum.Step.Payment">
                <div class="image">
                    <img src="https://api.vietqr.io/image/970416-4181961-VmQSuKZ.jpg?accountName=HOANG%20ANH%20QUAN&amount=10000&addInfo=HAQ%20CK" alt="">
                </div>
            </div>
            ...
            <div class="btn-cart">
                ...
                <div class="final-money d-flex align-items space-between " v-show="step == Enum.Step.InfoOrder || step == Enum.Step.Payment">
...
.total-money, .final-money, .discount-money{
    padding: 5px 0;
}
...
.order-succes .note p, .order-succes .note i{
    margin: 0 5px 10px;
}

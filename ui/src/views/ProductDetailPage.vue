<template>
    <div class="product-detail">
        <div class="container">
            <h1 class="name-product">{{ product.productName }}</h1>
            <div class="main-info-product d-flex">
                ...
                <div class="main-product-mid">
                    <div class="price-sell">
                        {{ product.status == Enum.StatusProduct.Selling ? formatMoney(getNewPrice(product.price, product.discount)) 
            ...
            <div class="detail-info-product d-flex">
                <div class="more-info-product">
                    ...
                    <div :class="['content', { 'more-content': moreContent == true }]"></div>
...
export default {
    ...
    methods: {
        ...
        async getProductByID() {
            try {
                let url = `Product/${this.$route.query.productId}`;
                await axios.get(url)
                    .then((response) => {

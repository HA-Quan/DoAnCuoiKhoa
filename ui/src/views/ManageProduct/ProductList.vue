<template>
    ...
    <div v-else class="body flex-column " style="outline: none;" tabindex="0"
        @keydown.ctrl.shift.o.prevent.exact="addProduct">
        ...
        <div class="toolbar flex-row">
            <div class="toolbar-left flex-row">
                ...
                <div v-show="isFilter" @click="filterProductDefault" class="cancel-seleted pointer">{{
                ...
                <table cellpadding="0" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <th @click="sortData(Enum.Sort.NameAsc)" class="pointer">
                                <div class="flex-row">
                            ...
                            <th class="col-100 pointer" @click="sortData(Enum.Sort.QuantityAsc)">
                                <div class="flex-row">
                            ...
                            <th class="col-120 pointer" @click="sortData(Enum.Sort.PriceAsc)" >
                                <div class="flex-row">
                            ...
                            <th class="col-100 pointer" @click="sortData(Enum.Sort.NumberSellAsc)">
                                <div class="flex-row">
                    ...
                    <tbody v-if="totalCount > 0">
                        <tr v-for="(product, index) in this.listProduct" @click.exact="focusIndex = index"
                            ...
                            <td>
                                {{ convertTime(product.createdDate) }}
                            </td>
                            <td>
    ...
    <BasePopup @close="closePopup" class="popup-delete" :title="this.titlePopup" :prefix="prefixPopup" :suffix="suffixPopup"
        :content="nameProductDelete" v-show="isShowPopup">
        <template #buttons>

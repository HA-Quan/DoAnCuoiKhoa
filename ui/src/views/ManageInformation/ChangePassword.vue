            ...
            <div class="info">
                <table>
                    <tbody>
                        <tr>
                            <td class="p-relative">
                                <p class="label">{{ Resource.Label.PasswordOld }}:</p>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td class="p-relative">
                                <p class="label">{{ Resource.Label.Password }}:</p>
                            </td>
                            <td>
                                <div class="text-field-form">
                        ...
                        <tr>
                            <td class="p-relative">
                                <p class="label">{{ Resource.Label.VerifyPassword }}:</p>
                            </td>
                            <td>
                                <div class="text-field-form">
    ...
    methods: {
        ...
        */
        ...
        validatePassword() {
            ...
            if (!new RegExp(validPassword).test(this.passwordModel.password)) {
